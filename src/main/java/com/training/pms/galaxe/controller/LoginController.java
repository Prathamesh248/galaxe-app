...
public class LoginController {
	...
	@RequestMapping(value = "/pratham", method = RequestMethod.GET)			//localhost:9094/ahmed
	public String ahmed() {
	...
	@RequestMapping(value = "/prathamesh", method = RequestMethod.GET)			//localhost:9094/shubham
	public String akshay() {
		return "prathamesh";					//  /WEB-INF/views/prathamesh.jsp
	}
}